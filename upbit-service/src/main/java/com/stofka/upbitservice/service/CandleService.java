...
import com.stofka.upbitservice.candle.*;
...
public class CandleService {
    ...
    public List<? extends CandleBase> getCandles(String code, String interval, int count) {
        String redisKey = code + ":" + interval;
        Duration ttl = Duration.ofMinutes(30);

        // Redis 먼저 조회
        List<? extends CandleBase> cached = switch (interval) {
        ...
        List<? extends CandleBase> candles = switch (interval) {
